  ...
  _generateStyles() {
    return `
      :host {
        ...
        --line-icon-size: 24px;
        --departure-item-background: rgba(255, 255, 255, 0.05);
    ...
    .folding-ramp-icon {
      color: #2196f3;
      opacity: 0.85;
      --mdc-icon-size: 24px; /* ~50% larger than 16px */
      margin-left: 6px;
